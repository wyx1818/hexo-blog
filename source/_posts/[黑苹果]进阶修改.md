...
![Framebuffer](https://cdn.zuiyu1818.cn/mac/Framebuffer.png)
...
![ig-platform-id](https://cdn.zuiyu1818.cn/mac/ig-platform-id.png)
...
![寻找FB](https://cdn.zuiyu1818.cn/mac/frame.gif)

右键显示包内容，在`/Contents/MacOS`里找到同名文件，移动至桌面

![移动FB](https://cdn.zuiyu1818.cn/mac/frame1.gif)

### 修改FB

使用`Hexo Fiend`，打开提取的文件，使用`Command+F`搜索前面的ig-platform-id(`0700260d`)

![搜索ID](https://cdn.zuiyu1818.cn/mac/frame2.gif)
...
![修改FB](https://cdn.zuiyu1818.cn/mac/FB.png)
...
![FB补丁](https://cdn.zuiyu1818.cn/mac/FB_patch.png)
...
![usb3](https://cdn.zuiyu1818.cn/mac/usb3.png)
...
2. 使用`IOregistryExplorer`，搜索`xhc`查看(推荐使用这个，这样可以看所有端口是否都已正常工作)
   ...
   ![IOService](https://cdn.zuiyu1818.cn/mac/XHC.png)
