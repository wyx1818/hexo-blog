...
![](https://cdn.zuiyu1818.cn/mac/FB_Final.png)
...
![Xcode](https://cdn.zuiyu1818.cn/mac/Xcode_Graphics_disable.png)
...
![](https://cdn.zuiyu1818.cn/mac/WEG_framebuffer_patch.png)
...
1. 在 BIOS 中设置核显所需的内存量（即 预分配 DVMT，英文: DVMT Pre-Allocated）为 32 MB, 64 MB, 96 MB 等，与使用的 FB 值相关。如要使用最大值（英文: DVMT Total），请设为 MAX。
   ...
   ![BIOS设置](https://cdn.zuiyu1818.cn/mac/bios.png)
...
3. 关闭所有Clover中的显卡注入
   ...
   ![关闭Graphics显卡注入](https://cdn.zuiyu1818.cn/mac/Clover_Graphics_disable.png)

   ![关闭Device中的显卡注入](https://cdn.zuiyu1818.cn/mac/Clover_Graphics_disable.png)
...
4. 禁用Clover中Apci的以下DSDT补丁
   ...
   ![关闭DSDT补丁](https://cdn.zuiyu1818.cn/mac/Clover_Acpi_DSDT.png)

   ![关闭DSDT补丁](https://cdn.zuiyu1818.cn/mac/Clover_Acpi_DSDT2.png)

5. 关闭Clover中Devices的`UseIntelHDMI`

   ![关闭UseIntelHDMI](https://cdn.zuiyu1818.cn/mac/Clover_Devices_UseInterHDMIpng.png)

6. 删除引导参数：`-disablegfxfirmware`

   ![删除引导参数](https://cdn.zuiyu1818.cn/mac/Clover_boot_HD.png)
...
7. 删除以下位置所有的和IGPU、HDMI相关条目（一般来说清空就行了）：
   ...
   ![删除IGPU](https://cdn.zuiyu1818.cn/mac/Clover_Device_IGPU.png)

8. 删除或禁用以下 ACPI 重命名补丁: `GFX0 to IGPU`, `PEGP to GFX0`, `HECI to IMEI`, `MEI to IMEI`, `HDAS to HDEF`, `B0D3 to HDAU`

   ![禁用Acpi补丁](https://cdn.zuiyu1818.cn/mac/Clover_Acpi_Patch.png)
...
![](https://cdn.zuiyu1818.cn//mac/daoxu.jpg)

下面分别提供了适用于不同微架构的常用 `IGPU` 和 `IMEI` 属性模版。

![Xcode](https://cdn.zuiyu1818.cn/mac/FB_template_xcode.png)

![clover中的设置](https://cdn.zuiyu1818.cn/mac/FB_template_Clover.png)
...
![启动参数设置igfxframe](https://cdn.zuiyu1818.cn/mac/Clover_Boot_Graphics.png)
...
![](https://cdn.zuiyu1818.cn/mac/FB_HD2000_Z77.png)
...
![](https://cdn.zuiyu1818.cn/mac/FB_HD2500.png)
...
![](https://cdn.zuiyu1818.cn/mac/FB_HD4600.png)
...
![](https://cdn.zuiyu1818.cn/mac/FB_UHD620.png)
...
![](https://cdn.zuiyu1818.cn/mac/FB_UHD630.png)
...
![](https://cdn.zuiyu1818.cn/mac/WEG_HDMI20.png)
